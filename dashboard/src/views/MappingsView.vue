...
function confirmDeleteMapping(event: Event, m: ModelProviderEndpointView) {
  confirm.require({
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr
            ...
            :class="{ selected: panel.isActive(mappingKey(m)) }"
          >
            ...
            <td class="col-actions">
              <div class="col-actions-cell">
                <button
                  class="btn-icon"
                  :class="{ 'btn-icon--active': panel.isActive(mappingKey(m)) }"
                  title="编辑"
                  aria-label="编辑"
                  @click="openEdit(m)"
                >
                ...
                <button class="btn-icon btn-icon--danger" title="删除" aria-label="删除" @click="(ev) => confirmDeleteMapping(ev, m)">
