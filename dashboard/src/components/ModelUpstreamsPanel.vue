  ...
  <SidePanel :title="modelName" kicker="上游" @close="emit('close')">
    ...
    <section class="flex flex-col gap-2">
      ...
      <ul v-else class="list-none m-0 p-0 flex flex-col gap-2">
        ...
        >
          <header class="px-2.5 py-1.5 bg-surface-50 border-b border-line flex items-baseline gap-2">
            <span class="text-2xs font-medium text-ink-muted uppercase tracking-[0.03em] flex-none">
