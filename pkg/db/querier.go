...
type Querier interface {
	...
	GetOverviewCostSummary(ctx context.Context, arg GetOverviewCostSummaryParams) ([]GetOverviewCostSummaryRow, error)
	GetOverviewDistribution(ctx context.Context, arg GetOverviewDistributionParams) ([]GetOverviewDistributionRow, error)
	GetOverviewHourlyCostSeries(ctx context.Context, arg GetOverviewHourlyCostSeriesParams) ([]GetOverviewHourlyCostSeriesRow, error)
	GetOverviewHourlyRequestSeries(ctx context.Context, arg GetOverviewHourlyRequestSeriesParams) ([]GetOverviewHourlyRequestSeriesRow, error)
	GetOverviewHourlyTraceSeries(ctx context.Context, arg GetOverviewHourlyTraceSeriesParams) ([]GetOverviewHourlyTraceSeriesRow, error)
	GetOverviewSummary(ctx context.Context, arg GetOverviewSummaryParams) (GetOverviewSummaryRow, error)
	GetOverviewTraceCount(ctx context.Context, arg GetOverviewTraceCountParams) (int64, error)
